...
\hlink{CRAN}{http://cran.r-project.org/src/contrib/PACKAGES.html}.  Store these
  ...
  default R program directory is {\tt C:{\textbackslash}Program
  Files{\textbackslash}R{\textbackslash}\rwvers{\textbackslash}}.\footnote{Note
  that when updating R to the latest release, the installer does not
  delete previous versions from your {\tt C:{\textbackslash}Program
  Files{\textbackslash}R{\textbackslash}} directory.  In this example, the
  subdirectory {\tt {\textbackslash}\rwvers{\textbackslash}} stores R version
...
\item An additional \emph{recommended but optional step} is to set up
  ...
  located in the R program subdirectory ({\tt C:{\textbackslash}Program
    Files{\textbackslash}R{\textbackslash}\rwvers{\textbackslash}etc{\textbackslash}}
...
which is by default {\tt C:{\textbackslash}Program
  Files{\textbackslash}R{\textbackslash}\rwvers{\textbackslash}library{\textbackslash}Zelig{\textbackslash}}.
...
\ref{table.compat1} in the Appendix for a list of packages tested to be
